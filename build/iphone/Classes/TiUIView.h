...
/**
 Base class for all UIowaAlumni views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the UIowaAlumni view hierarchy (such as wrapped iOS UIViews) was touched.
