...
//@interface UIowaAlumniObject : NSObject
//@end

@interface UIowaAlumniObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UIowaAlumniObject class]])
		{
			for (NSString *key in [[(UIowaAlumniObject*)o modules] allKeys])
			{
