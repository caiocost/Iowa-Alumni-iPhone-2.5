...
@interface UIowaAlumniObject : KrollCoverageObject {
#else
@interface UIowaAlumniObject : KrollObject {
#endif
@private
...
extern NSString * UIowaAlumni$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	UIowaAlumniObject *_uiowaalumni;
    KrollObject* console;
	BOOL shutdown;
