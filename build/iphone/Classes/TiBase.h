...
// in simulator we redefine to format for UIowaAlumni Developer console
...
{\
	NSString * exceptionName = [@"org.uiowaalumni." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uiowaalumni";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIUIowaAlumniNativeItemNone = -1, 
	UIUIowaAlumniNativeItemSpinner = -2,
	UIUIowaAlumniNativeItemProgressBar = -3,
	
	UIUIowaAlumniNativeItemSlider = -4,
	UIUIowaAlumniNativeItemSwitch = -5,
	UIUIowaAlumniNativeItemMultiButton = -6,
	UIUIowaAlumniNativeItemSegmented = -7,
	
	UIUIowaAlumniNativeItemTextView = -8,
	UIUIowaAlumniNativeItemTextField = -9,
	UIUIowaAlumniNativeItemSearchBar = -10,
	
	UIUIowaAlumniNativeItemPicker = -11,
	UIUIowaAlumniNativeItemDatePicker = -12,
	
	UIUIowaAlumniNativeItemInfoLight = -13,
	UIUIowaAlumniNativeItemInfoDark = -14,
	
	UIUIowaAlumniNativeItemDisclosure = -15,
	
	UIUIowaAlumniNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UIowaAlumni instances of
